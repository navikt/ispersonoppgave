...
fun launchKafkaTaskMeldingFraBehandler(
    ...
    val meldingFraBehandlerConsumer = MeldingFraBehandlerConsumer(
        meldingFraBehandlerService = meldingFraBehandlerService,
    )
    ...
    launchKafkaTask(
        applicationState = applicationState,
        kafkaConsumerService = meldingFraBehandlerConsumer,
        consumerProperties = consumerProperties,
        topics = listOf(MeldingFraBehandlerConsumer.Companion.MELDING_FRA_BEHANDLER_TOPIC),
    )
}

class MeldingFraBehandlerConsumer(
    ...
    companion object {
        ...
        private val log: Logger = LoggerFactory.getLogger(MeldingFraBehandlerConsumer::class.java)
    }
}
